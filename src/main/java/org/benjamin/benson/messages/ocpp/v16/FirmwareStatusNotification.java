...
public class FirmwareStatusNotification {
    ...
    public String toString() {
        ...
        sb.append(FirmwareStatusNotification.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FirmwareStatusNotification) == false) {
            return false;
        }
        FirmwareStatusNotification rhs = ((FirmwareStatusNotification) other);
