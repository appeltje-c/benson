...
public class EVSE {
    ...
    public boolean equals(Object other) {
        ...
        EVSE rhs = ((EVSE) other);
        return ((((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData)))&&((this.connectorId == rhs.connectorId)||((this.connectorId!= null)&&this.connectorId.equals(rhs.connectorId))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))));
    }
