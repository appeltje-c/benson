...
public class ClearChargingProfileRequest {
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.chargingProfileCriteria == rhs.chargingProfileCriteria)||((this.chargingProfileCriteria!= null)&&this.chargingProfileCriteria.equals(rhs.chargingProfileCriteria)))&&((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData))))&&((this.chargingProfileId == rhs.chargingProfileId)||((this.chargingProfileId!= null)&&this.chargingProfileId.equals(rhs.chargingProfileId))));
    }
