...
public class CertificateSignedRequest {
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.certificateChain == rhs.certificateChain)||((this.certificateChain!= null)&&this.certificateChain.equals(rhs.certificateChain)))&&((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData))))&&((this.certificateType == rhs.certificateType)||((this.certificateType!= null)&&this.certificateType.equals(rhs.certificateType))));
    }
